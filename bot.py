        ...
        for channel in force_sub_channels:
            if channel:
                try:
                    ...
                    self.LOGGER(__name__).warning(f"Please Double check the FORCE_SUB_CHANNEL value and Make sure Bot is Admin in channel with Invite Users via Link Permission, Current Channel Value: {channel}")
